...
function Header() {
  ...
  return (
        ...
        <div className='header'>
           ...
           <div className='logo'>
            <NavLink to={'/'}><img src='\logo3.png' alt=''></img></NavLink>
           </div>
           ...
           <div className='search'>
            ...
            <div className='others'>
              <div>
                {
                   localStorage.getItem('currentUser') && <div className='loggedin'>
                   <div>
                     <Fab onClick={showDropDown} className='acco' sx={{ m: 0, minWidth: 20,backgroundColor:"gray"}} color="primary" aria-label="add">
                         <img src='/user.png' className ="dropbtn" style={{width:"20px"}} alt=''></img>
                     </Fab>
                     <div ref={accRef} className="dropdown-content">
                       <NavLink onClick={showDropDown} style={navStyle} to="/myaccount">My Account</NavLink>
                       <NavLink onClick={showDropDown} style={navStyle} to="/myorders">My Orders</NavLink>
                       <NavLink onClick={showDropDown} style={navStyle} to="/settings">Settings</NavLink>
              ...
              <div>
                {
                 !localStorage.getItem('currentUser') && <div className='loggedout'>
